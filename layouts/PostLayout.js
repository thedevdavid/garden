          ...
          >
            ...
            <footer>
              ...
              {isSubmitSuccessful ? (
                ...
                <div className="w-100 bg-gray-100 p-4 rounded-lg">
                  ...
                  <form className="sm:flex flex-col" onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <input
                      ...
                      autoComplete="email"
                      required
                      className="w-full border-gray-500 px-5 py-3 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-indigo-700 focus:ring-gray-800 rounded-md"
                  ...
                  <p className="mt-3 text-sm text-gray-600">I won't spam. Promise.</p>
                </div>
              )}
              <div className="pt-4 xl:pt-8">
                <Link href="/content" className="text-primary-500 hover:text-primary-600">
