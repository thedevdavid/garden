...
draft: false
summary: 'Quick guide on how to achive the hyped glass morphism effect with Tailwind (updated with Tailwind v2.1)'
---
...
[Here's the Play link for the updated code](https://play.tailwindcss.com/iJ7G1Qj25M)
