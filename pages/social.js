          ...
          <div className="grid gap-8 items-start my-2">
            <div className="relative group">
              ...
              <Link href="https://dvdlv.me/yt">
                <a className="relative px-7 py-4 bg-white rounded-lg leading-none flex items-center divide-x divide-gray-600">
                  <span className="flex items-center space-x-5">
                    ...
                    <span className="pr-6 text-gray-900">
                      2 videos weekly on my YouTube channel
                    </span>
                  </span>
                  <span className="pl-6 text-amber-400 group-hover:text-gray-900 transition duration-200">
                    Go &rarr;
                  </span>
                </a>
              </Link>
              ...
              <Link href="https://tiktok.com/@iamdavidlevai">
                <a className="relative px-7 py-4 bg-white rounded-lg leading-none flex items-center divide-x divide-gray-600">
                  <span className="flex items-center space-x-5">
                    ...
                    <span className="pr-6 text-gray-900">Dropping byte-sized tips on TikTok</span>
                  </span>
                  <span className="pl-6 text-indigo-400 group-hover:text-gray-900 transition duration-200">
                    Go &rarr;
                  </span>
                </a>
              </Link>
              ...
              <Link href="https://instagram.com/iamdavidlevai">
                <a className="relative px-7 py-4 bg-white rounded-lg leading-none flex items-center divide-x divide-gray-600">
                  <span className="flex items-center space-x-5">
                    ...
                    <span className="pr-6 text-gray-900">Travel & Fitness on IG</span>
                  </span>
                  <span className="pl-6 text-primary-400 group-hover:text-gray-900 transition duration-200">
                    Go &rarr;
                  </span>
                </a>
              </Link>
